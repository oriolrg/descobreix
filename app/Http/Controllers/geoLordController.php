...
class geoLordController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('geoLord/geoLordadmin');
     ...
     *
     */
    public function geoLordadd()
    {
        //$restaurants = $this->llistarRestaurants();
        return view('geoLord/geoLordaddcircuit');//->with('restaurants', $restaurants);
     ...
     */
    public function geoLordpost(Request $request)
    {
        ...
        //return $noucircuit;
        $Circuit = new Circuits();
        if($Circuit->insertarCircuit($noucircuit))
        {
            return redirect('/geolord/addCircuit');
        };
    }
